...
export const LEVEL_THRESHOLDS: number[] = [
  ...
  1114207, 1145405, 1177304, 1209919, 1243267, 1277365, 1312229, 1347876, 1384325, 1421592, 1459697,
  1498658, 1538495, 1579226, 1620873, 1663456, 1706996, 1751514, 1797032, 1843574, 1891161, 1939817,
  1989567, 2040435, 2092446, 2145625, 2200000,
];
