...
export function SkillRadarScreen({ navigation }: Props) {
  ...
  useEffect(() => {
    ...
    getMySkills(accessToken)
      .then(setSkills)
      .catch(() => setError('Could not load your Skill Radar.'));
  }, [accessToken]);
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitle}>Where your language ability is strongest right now.</Text>
          ...
          <View key={dim.key} style={styles.row}>
            <View style={styles.rowHeader}>
              ...
              <Text style={styles.rowValue}>
                {dim.measured ? `${dim.score}` : 'Not yet measured'}
              </Text>
            </View>
